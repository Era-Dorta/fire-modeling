...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Save current x label position
xlabel_h = get(h, 'XLabel');
xlabelpos = xlabel_h.Position;
...
% Leave the xlabel in its original position
xlabel_h.Position = xlabelpos;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Save current x label position
ylabel_h = get(h, 'YLabel');
ylabelpos = ylabel_h.Position;
...
% Leave the ylabel in its original position
ylabel_h.Position = ylabelpos;