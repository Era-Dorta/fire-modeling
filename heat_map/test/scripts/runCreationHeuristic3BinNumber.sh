...
for i in ${BIN_SIZES[@]}; do
	nice -n20 matlab -nodesktop -nosplash -r "args_path = '~/bath-fire-shader/heat_map/test/data/args_test21.mat'; creation_fnc_n_bins = ${i}; save(args_path, 'creation_fnc_n_bins', '-append'); exit();"
