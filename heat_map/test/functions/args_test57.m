function [args_path] = args_test57()
%ARGS_TEST57 ICM 32 close, goal-aligned, gaussian, Lab, eval_half
%   ARGS_PATH = ARGS_TEST57() Returns in ARGS_PATH the file path of a .mat
...
initGuessFnc = @getInitHeatMapScaled_icm;
