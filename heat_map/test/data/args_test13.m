function [args_path] = args_test13()
%ARGS_TEST13 Ga, copper-ld, single goal, 200 Population
%   ARGS_PATH = ARGS_TEST13() Returns in ARGS_PATH the file path of a .mat
...
goal_img_path = {'~/maya/projects/fire/data/fire-test-pics/copper-ld.png'};
goal_mask_img_path = {'~/maya/projects/fire/data/fire-test-pics/trimap/copper-ld-mask.png'};
