...
Our input data was captured with a six mvBlueCOUGAR-XD104 cameras, as shown in Figure~\ref{fig:capture_system}.
We experimented with during several capture sessions with different illumination conditions, sensor gains, flame types, and other parameters.
The captured data was reconstructed and edited using techniques that are out of the scope of this report.
