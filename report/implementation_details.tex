...
The implementation of the model was realised with several shaders for \MentalRay to be used in \Maya.
Using a rendering engine like \MentalRay, which provides the basic functionality needed for ray tracing, reduces bugs in the code and increases productivity.
...
A test scene in \Maya with objects using our shaders is shown in Figure~\ref{fig:application_example}.
