...
As there are several parameters to explore, and their behaviour is non-linear, it is reasonable to expect that the function will have a number of local minima, thus requiring more advanced optimization methods, such as genetic programming.
