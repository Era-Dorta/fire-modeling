...
\setcounter{tocdepth}{1} % Don't show subsections in the index
...
\newcommand{\Mayash}{Maya\textsuperscript\textregistered}
\newcommand{\MentalRaysh}{Mental Ray\textsuperscript\textregistered}
