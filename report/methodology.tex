...
We refer the readers to~\cite{Fairchild:2005} for an in depth review of such methods.
...
\cite{Irawan:2005} presented neural network-based model which includes time varying adaptations, and it also considers variations due to the observer characteristics, such as their age or visual impairment.
