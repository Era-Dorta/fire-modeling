...
def abscoef_HT(table=None,step=None,file=None):
    return absorptionCoefficient_HT(SourceTables=table,OmegaStep=step,File=file)

def abscoef_Voigt(table=None,step=None,file=None):
    return absorptionCoefficient_Voigt(SourceTables=table,OmegaStep=step,File=file)
    
def abscoef_Lorentz(table=None,step=None,file=None):
    return absorptionCoefficient_Lorentz(SourceTables=table,OmegaStep=step,File=file)

def abscoef_Doppler(table=None,step=None,file=None):
    return absorptionCoefficient_Doppler(SourceTables=table,OmegaStep=step,File=file)
    
def abscoef(table=None,step=None,file=None): # default
    return absorptionCoefficient_Lorentz(SourceTables=table,OmegaStep=step,File=file)
