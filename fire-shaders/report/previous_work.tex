...
Building on the work on a semi-Lagrangian fluid solver of~\cite{Stam:1999}, a model which includes gaseous fuel and gaseous byproducts was proposed by~\cite{Nguyen:2002}. \cite{Horvath:2009}

\textbf{High-speed combustions}
\cite{Feldman:2003} \cite{Hong:2007}

\textbf{Erosion} and sound paper
