...
For the radius of the soot particles, \cite{Dalzell:1969} states that their size is in the range $R \in \lbrace 50 \ldots 800 \rbrace \AA$, taking the mean value $R = 425 \times 10^{-10}$ metres in our case.
...
The refraction index $\eta$ varies across the medium, the procedure to compute it is described in Section~\ref{sec:refraction}.
