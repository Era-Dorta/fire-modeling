...
\item Emitted light $L_e(\lxo)$ by \textbf{black body radiation} effects
...
where $\omegam_i$ is the outgoing direction, $g$ can be a function of the wavelength, although in most cases is chosen to be constant.
...
Monte Carlo techniques can be used to efficiently sample outgoing light scattering directions $\omegam_i$.
